...
with: x-amz-content-sha256: STREAMING-AWS4-HMAC-SHA256-PAYLOAD-TRAILER
...
Usage:
    python3 s3_stream_sha256_trailer.py my-bucket us-east-1 test/key.bin 1048576 [--endpoint http://host:port]
...
def main():
    parser = argparse.ArgumentParser(
        description="Upload a generated file to S3 using SigV4 aws-chunked streaming with SHA256 payload trailer."
    )
    ...
    decoded_len = size
    payload_hash_header_value = "STREAMING-AWS4-HMAC-SHA256-PAYLOAD-TRAILER"
